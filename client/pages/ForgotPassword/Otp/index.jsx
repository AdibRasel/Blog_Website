        ...
        <div>
            ...
            <div className="w-full md:w-[50%] m-auto h-full md:h-[600px]">
                <div className="pt-10 shadow-lg p-5 border-2 rounded-lg m-5">
                    <h1 className="text-4xl py-5 text-center ">OTP</h1>
                    <label className="">Enter OTP Code</label>
                    {/* <OtpInput 
                    value={otp}
                    onChange={setOtp}
                    numInputs={6}
                    ...
                    /> */}
                    <input type="number" placeholder="OTP"  className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
                    <Link href='/ForgotPassword/NewPassword'>
